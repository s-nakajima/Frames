		...
		<main class="<?php echo $this->PageLayout->getContainerFluid(); ?>">
			...
			<div class="row">
				...
				<div role="main" id="container-main" class="<?php echo $this->PageLayout->getContainerSize(Container::TYPE_MAIN); ?>"
					 ng-controller="FrameSettingsController" ng-init="initialize({frame: <?php echo h(json_encode(NetCommonsAppController::camelizeKeyRecursive($this->PageLayout->frame))) ?>})">

					<section class="frame panel panel-{{frame.headerType}}">
						<div class="panel-heading clearfix">
							<?php echo $this->element('Frames.setting_header', array('frame' => $this->PageLayout->frame)); ?>
						</div>
